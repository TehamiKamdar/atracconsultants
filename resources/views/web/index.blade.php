    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <h2 class="hero-subtitle">September 2025-26 Intake</h2>
            ...
            statValues.forEach(stat => {
                ...
                const animate = () => {
                    ...
                    if (dataType === 'percentage') {
                        stat.textContent = current.toFixed(1) + '%';  // one decimal
                    } else {
                        stat.textContent = Number(current.toFixed(1)).toLocaleString(); // with commas
                    }
