        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body p-4 p-md-5">
                    ...
                    <h3 class="h4 text-primary mb-4">Hafiz Kamran Yameen, Founder & CEO</h3>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4 p-md-5">
                    <h3 class="h4 text-primary mb-3" style="font-family: 'Bambino-Bold', sans-serif;">General Manager - Karachi Branch</h3>
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-4">
                            <i class="ri-user-3-line leader-icon" style="font-size: 2.5rem;"></i>
                        </div>
                        <div>
                            <h4 class="mb-0" style="font-family: 'Bambino-Bold', sans-serif;">Dr. Uzair Yameen</h4>
                        </div>
                    </div>
                    <p class="mb-3">
At Atrac Consultants, we believe in giving students the exposure they need to face the real world with confidence. This is more than just an invitation — it's a chance to grow where your ideas are valued and your journey matters.
                    </p>
                    <p class="mb-0 fw-bold" style="font-family: 'Bambino-Bold', sans-serif;">
                        I invite you to explore how we can help you achieve your international education goals.
                    </p>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4 p-md-5">
                    <h3 class="h4 text-primary mb-3" style="font-family: 'Bambino-Bold', sans-serif;">General Manager - Islamabad Branch</h3>
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-4">
                            <i class="ri-user-3-line leader-icon" style="font-size: 2.5rem;"></i>
                        </div>
                        <div>
                            <h4 class="mb-0" style="font-family: 'Bambino-Bold', sans-serif;">Arsalan</h4>
                        </div>
                    </div>
                    <p class="mb-3">
                        The future belongs to those who prepare for it today. At Atrac Consultants, we’re here to support students in discovering their strengths, building skills, and stepping forward with purpose and clarity.
                    </p>
                    <p class="mb-0 fw-bold" style="font-family: 'Bambino-Bold', sans-serif;">
                        I invite you to explore how we can help you achieve your international education goals.
                    </p>
