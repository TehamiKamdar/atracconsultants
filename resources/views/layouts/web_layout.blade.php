        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 footer-col">
                    ...
                    <p class="mb-4">Providing expert consultancy services with integrity and innovation to help businesses thrive in competitive markets.</p>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright" style="letter-spacing: 0.5;">
                        &copy; 2020 - {{ date('Y') }} <span class="text-primary" style="font-family: 'Bambino-Bold'">Atrac Consultants.</span> All rights reserved.
                    </div>
                </div>
            </div>
        </div>
