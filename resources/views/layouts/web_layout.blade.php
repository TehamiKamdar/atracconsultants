...
<body>
    <nav class="atrac-navbar navbar navbar-expand-lg" style="z-index: 100">
        <div class="container">
            ...
            <a class="navbar-brand" href="/">
                <img src="{{asset('webassets/newlogo-removebg-preview-BNhagA2w.png')}}" alt="Atrac Consultants" class="navbar-logo">
            </a>
    ...
    <div class="mobile-menu collapse d-lg-none" id="navbarContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="mobile-nav-link" href="#whywechoose">Why Choose Us</a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 footer-col">
                    <img src="{{ asset('webassets/newlogo-removebg-preview-BNhagA2w.png') }}" alt="Atrac Consultants Logo" class="footer-logo">
                ...
                <div class="col-lg-2 col-md-6 footer-col">
                    ...
                    <ul class="footer-links">
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> Business Strategy</a></li>
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> Financial Advisory</a></li>
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> Market Research</a></li>
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> Risk Management</a></li>
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> Digital Transformation</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6 footer-col">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> About Us</a></li>
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> Our Team</a></li>
                        <li><a href="#"><i class="ri-arrow-right-s-line"></i> Case Studies</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright">
                        <p>&copy; 2024 <span class="highlight">Atrac Consultants</span>. All Rights Reserved. | <a
                                href="#" class="text-white">Privacy Policy</a> | <a href="#" class="text-white">Terms of
                                Service</a></p>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function(){
            var typed = new Typed('#element', {
                strings: ["Study Abroad Opportunities", "Global Scholarships", "World-Class Education"],
                typeSpeed: 50,
                backSpeed: 30,
                loop: true
            });
